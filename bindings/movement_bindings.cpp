...
namespace movement_export
{
    ...
    void gyro_drive_straight_fn(int f, int t, object fn, double c, double a, int u)
    {
        gyro_drive_straight(f, t, fn, c, a, u);
    }

    void line_follow_basic_fn(int sp, Cliff cl, LineSide l, object fn, bool st, double co, int b, int u)
    {
        line_follow_basic(sp, cl, l, fn, st, co, b, u);
    }
    void line_follow_accelerate_linear_fn(int f, int t, Cliff cl, LineSide l, object fn, bool s, double co, double a, int b, int u)
    {
        line_follow_accelerate_linear(f, t, cl, l, fn, s, co, a, b, u);
    }
    void line_follow_accelerate_sinusoidal_fn(int f, int t, Cliff cl, LineSide l, object fn, bool s, double co, double a, int b, int u)
    {
